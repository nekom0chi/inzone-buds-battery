...
- `INZONE Buds Battery Native.exe`
- Win32 APIで作った軽量版です
- Pythonなしで使えます
- 手元の実測では、通常版のexeが約30MB、Native版のexeが約2.8MBでした
- まだ試作版なので、まずは通常版を安定版として扱ってください
...
MinGW/WinLibs の `g++` が必要です。Visual Studio Build Tools を使う場合は `native\build_msvc.bat` を使えます。
